...
public class PlayerInteraction implements Listener {
    ...
    public void onBreak(BlockBreakEvent e){ // edited by Pinont_
        ...
        if (!(Armored.build.contains(p.getName())) && !(Armored.barn.contains(p.getLocation()) || Armored.farm.contains(p.getLocation())) && Armored.spawn.contains(p.getLocation()) && e.getBlock().getType() != Material.FARMLAND) {
                e.setCancelled(true);
        }
    }
    @EventHandler
    public void onSplash(PotionSplashEvent e){
        ...
        if(!(Armored.barn.contains(e.getEntity().getLocation()) || Armored.farm.contains(e.getEntity().getLocation())) && Armored.spawn.contains(entity.getLocation())){
            e.setCancelled(true);
        }
    }
    @EventHandler
